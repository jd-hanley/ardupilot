...
{
    // Call timer at 60 hz
    _dev->register_periodic_callback(16666, FUNCTOR_BIND_MEMBER(&AP_Centeye_Nano_Backend::timer, void));
...
bool AP_Centeye_Nano_Backend::read_objdet()
{
    ...
    hal.console->printf("Raw buffer: ");
    for (uint8_t i = 0; i < ODOM_BYTES; i++) {
